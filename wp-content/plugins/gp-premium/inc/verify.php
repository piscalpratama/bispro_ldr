...
?>
	...
	<form method="post" action="options.php">
		...
		<div class="postbox generate-metabox" id="generate-license-keys">
			<h3 class="hndle"><?php printf( __( 'Updates %s' ), '' );?> <a class="update-help" title="<?php _e( 'Help' ); ?>" href="https://docs.generatepress.com/article/updating-gp-premium/" target="_blank"><span class="dashicons dashicons-sos"></span></a></h3>
